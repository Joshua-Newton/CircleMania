...
TriangleUp slowSizePlusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleDown slowSizeMinusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleLeft slowSizeMinusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleRight slowSizePlusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);

TriangleUp mediumSizePlusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleDown mediumSizeMinusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleLeft mediumSizeMinusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleRight mediumSizePlusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);

TriangleUp fastSizePlusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleDown fastSizeMinusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleLeft fastSizeMinusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleRight fastSizePlusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);

TriangleUp pickupSizePlusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleDown pickupSizeMinusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleLeft pickupSizeMinusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleRight pickupSizePlusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);

TriangleUp playerSpeedPlusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleDown playerSpeedMinusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleLeft playerSpeedMinusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleRight playerSpeedPlusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);

TriangleUp slowSpeedPlusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleDown slowSpeedMinusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleLeft slowSpeedMinusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleRight slowSpeedPlusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);

TriangleUp mediumSpeedPlusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleDown mediumSpeedMinusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleLeft mediumSpeedMinusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleRight mediumSpeedPlusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);

TriangleUp fastSpeedPlusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleDown fastSpeedMinusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleLeft fastSpeedMinusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleRight fastSpeedPlusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);

TriangleUp bulletSpeedPlusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleDown bulletSpeedMinusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleLeft bulletSpeedMinusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleRight bulletSpeedPlusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
...
TriangleLeft slowHealthMinusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleRight slowHealthPlusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);

TriangleUp mediumHealthPlusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleDown mediumHealthMinusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleLeft mediumHealthMinusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleRight mediumHealthPlusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);

TriangleUp fastHealthPlusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleDown fastHealthMinusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleLeft fastHealthMinusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleRight fastHealthPlusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);

TriangleUp playerAmmoPlusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleDown playerAmmoMinusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleLeft playerAmmoMinusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleRight playerAmmoPlusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);

TriangleUp pickupDropRatePlusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleDown pickupDropRateMinusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleLeft pickupDropRateMinusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleRight pickupDropRatePlusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);

TriangleUp spawnRatePlusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleDown spawnRateMinusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleLeft spawnRateMinusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleRight spawnRatePlusOne(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);

TriangleUp spawnRateSecondsPlusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
TriangleDown spawnRateSecondsMinusTen(SETTINGS_TRIANGLE_LENGTH, SETTINGS_TRIANGLE_COLOR);
